...
xm edit                    # открыть конфиг (автоматически создаст бэкап - BACKUP_DIR="/usr/local/etc/xray/backups")
...
xm backups                 # посмотреть все бэкапы

# Интерактивно — покажет список, выбираешь номер
xm uri
